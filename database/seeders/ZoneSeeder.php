...
class ZoneSeeder extends Seeder
{
    ...
    {
        $zones = [
            ['name' => 'Jaipur East', 'district' => 'Jaipur', 'state' => 'Rajasthan', 'division_id' => 1],
            ['name' => 'Jaipur West', 'district' => 'Jaipur', 'state' => 'Rajasthan', 'division_id' => 1],
            ['name' => 'Jodhpur Rural', 'district' => 'Jodhpur', 'state' => 'Rajasthan', 'division_id' => 2],
            ['name' => 'Udaipur North', 'district' => 'Udaipur', 'state' => 'Rajasthan', 'division_id' => 3],
            ['name' => 'Ajmer Cantt', 'district' => 'Ajmer', 'state' => 'Rajasthan', 'division_id' => 4],
